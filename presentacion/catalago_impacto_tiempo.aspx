<%@ Page Title="" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="catalago_impacto_tiempo.aspx.cs" Inherits="presentacion.catalago_impacto_tiempo" %>
       ...
       <script type="text/javascript">
        ...
        function ConfirmEntregableDelete(id_permiso) {
            if (confirm('¿Desea eliminar este impacto?')) {
                var hdfusuario = document.getElementById('<%= hdfid_riesgo_impacto_tiempo.ClientID %>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12">
                <h4 class="page-header">Catálogo impacto tiempo</h4>
    ...
    <div class="row">
                ...
                Nuevo impacto&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>
                    ...
                    <div class="table-responsive">
                        <table class="dvv table no-margin table-condensed">
                            ...
                            <tbody>
                                <asp:Repeater ID="repeat_impactotiempo" runat="server">
                                    <ItemTemplate>
                                        <tr style="font-size: 12px">
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return EditarClick("+Eval("id_riesgo_impacto_tiempo")+");" %>'>
                                                    <i class="fa fa-pencil fa-2x" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return ConfirmEntregableDelete("+Eval("id_riesgo_impacto_tiempo")+");" %>'>
       ...
       <div class="modal fade bs-example-modal-lg" tabindex="-1" id="ModalImpactotiempo" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false">
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Detalles del impacto en tiempo</h4>
                        </div>
     ...
     <asp:HiddenField ID="hdfid_riesgo_impacto_tiempo" runat="server" />
</asp:Content>
