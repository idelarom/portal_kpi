<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MP/Global.Master" AutoEventWireup="true" CodeBehind="catalogo_periodicidad_bonos.aspx.cs" Inherits="presentacion.Pages.Catalogs.catalogo_periodicidad_bonos" %>
      ...
      <script type="text/javascript">
        ...
        function ConfirmEntregableDelete(id_permiso) {
            if (confirm('¿Desea eliminar este tipo de bono?')) {
                var hdfusuario = document.getElementById('<%= hdfid_periodicity.ClientID %>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12">
          <h4 class="page-header">Catálogo periodicidad de bonos</h4>          
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-danger">
                <div class="box-body"><asp:LinkButton ID="lnknuevaperiodicidad" CssClass="btn btn-primary btn-flat" runat="server" OnClick="lnknuevaperiodicidad_Click">
                Nuevo Tipo de periodicidad&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>
            </asp:LinkButton>
                    <div class="table-responsive">
                        <table class="dvv table no-margin table-condensed">
                            ...
                            <tbody>
                                <asp:Repeater ID="repeat_periodicity" runat="server">
                                    <ItemTemplate>
                                        <tr style="font-size: 12px">
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return EditarClick("+Eval("id_periodicity")+");" %>'>
                                                    <i class="fa fa-pencil fa-2x" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return ConfirmEntregableDelete("+Eval("id_periodicity")+");" %>'>
       ...
       <div class="modal fade bs-example-modal-lg" tabindex="-1" id="Modalperiodicidad" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg" role="document">
            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="lnknuevaperiodicidad" EventName="Click" />
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Detalles del tipo de periodicidad</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <h5><strong><i class="fa fa-bars" aria-hidden="true"></i>&nbsp;Nombre de la periodicidad</strong></h5>
                                    <asp:TextBox ID="txtperiodicidad" MaxLength="250" CssClass=" form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    <asp:Button ID="btneliminar" OnClick="btneliminar_Click" runat="server" Text="Button" Style="display: none;" />
     ...
     <asp:HiddenField ID="hdfid_periodicity" runat="server" />
</asp:Content>