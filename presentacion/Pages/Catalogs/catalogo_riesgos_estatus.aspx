<%@ Page Title="Riesgos Estatus" Language="C#" MasterPageFile="~/Pages/MP/Global.Master" AutoEventWireup="true" CodeBehind="catalogo_riesgos_estatus.aspx.cs" Inherits="presentacion.Pages.Catalogs.catalogo_riesgos_estatus" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-danger">
                ...
                Nuevo estatus&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>
            </asp:LinkButton>
                        ...
                        <table class="dvv table no-margin table-condensed">
                            <thead>
                                <tr style="font-size: 12px;">
                                    ...
                                    <th style="width: 20px; text-align: center;" scope="col"></th>
                                    <th style=" min-width:400px; text-align: left;" scope="col">Estatus</th>
                                </tr>
                            </thead>
                            <tbody>
