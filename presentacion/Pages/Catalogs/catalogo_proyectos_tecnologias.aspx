<%@ Page Title="Proyectos Tecnologias" Language="C#" MasterPageFile="~/Pages/MP/Global.Master" AutoEventWireup="true" CodeBehind="catalogo_proyectos_tecnologias.aspx.cs" Inherits="presentacion.Pages.Catalogs.catalogo_proyectos_tecnologias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12">
          <h4 class="page-header">Catálogo proyectos tecnologias</h4>          
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-danger">
                ...
                Nueva tecnología&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>
            </asp:LinkButton>
                        ...
                        <table class="dvv table no-margin table-condensed">
                            <thead>
                                <tr style="font-size: 12px;">
                                    ...
                                    <th style="width: 20px; text-align: center;" scope="col"></th>
                                    <th style=" min-width:400px; text-align: left;" scope="col">Tecnología</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <h5><strong><i class="fa fa-bars" aria-hidden="true"></i>&nbsp;Tecnología</strong></h5>
