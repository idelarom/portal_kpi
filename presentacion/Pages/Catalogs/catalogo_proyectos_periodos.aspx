<%@ Page Title="Proyectos Periodos" Language="C#" MasterPageFile="~/Pages/MP/Global.Master" AutoEventWireup="true" CodeBehind="catalogo_proyectos_periodos.aspx.cs" Inherits="presentacion.Pages.Catalogs.catalogo_proyectos_periodos" %>
      ...
      <script type="text/javascript">
        ...
        function ConfirmEntregableDelete(id_permiso) {
            if (confirm('¿Desea eliminar este permiso?')) {
                var hdfusuario = document.getElementById('<%= hdfid_proyecto_periodo.ClientID %>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12">
                <h4 class="page-header">Catálogo proyectos periodos</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-danger">
                ...
                Nuevo periodo&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>
            </asp:LinkButton>
                        ...
                        <table class="dvv table no-margin table-condensed">
                            <thead>
                                <tr style="font-size: 12px;">
                                    ...
                                    <th style="width: 20px; text-align: center;" scope="col"></th>
                                    <th style=" min-width:400px; text-align: left;" scope="col">Periodo</th>
                                    <th style=" min-width:60px; text-align: left;" scope="col">Duración</th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <tr style="font-size: 12px">
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return EditarClick("+Eval("id_proyecto_periodo")+");" %>'>
                                                    <i class="fa fa-pencil fa-2x" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td style="text-align: center;">
                                                <a style="cursor: pointer;"
                                                    onclick='<%# "return ConfirmEntregableDelete("+Eval("id_proyecto_periodo")+");" %>'>
                                                    <i class="fa fa-trash fa-2x" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td style="text-align: left;"><%# Eval("nombre") %></td>
                                            <td style="text-align: left;"><%# Eval("dias") %></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </tbody>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Detalles del periodo</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <h5><strong><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;Numero de dias</strong></h5>
                                    <asp:TextBox  onblur="ValidateRange(this,1,30,'El valor debe ser de 0 - 30 dias');"   onkeypress="return validarEnteros(event);"  ID="txtnumdias" TextMode="Number" CssClass=" form-control" Width="150px" runat="server"></asp:TextBox>
    ...
    <asp:Button ID="btneliminar" OnClick="btneliminar_Click" runat="server" Text="Button" Style="display: none;" />
     ...
     <asp:HiddenField ID="hdfid_proyecto_periodo" runat="server" />
</asp:Content>
