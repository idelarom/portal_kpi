...
namespace datos.OPTRACKER
{
    ...
    public partial class tbl_Archivos
    {
        public int Id_CNSC_Archivo { get; set; }
        public Nullable<int> Id_CNSC_SubCotizacion { get; set; }
        public Nullable<int> Id_CNSC_Cotizacion { get; set; }
