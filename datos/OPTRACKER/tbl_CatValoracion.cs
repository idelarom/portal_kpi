...
namespace datos.OPTRACKER
{
    ...
    public partial class tbl_CatValoracion
    {
        public int Id_CNSC_CatValoracion { get; set; }
        public string Desc_Valoracion { get; set; }
        public Nullable<int> NumOrdenacion { get; set; }
