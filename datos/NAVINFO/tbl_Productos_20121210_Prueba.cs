...
namespace datos.NAVINFO
{
    ...
    public partial class tbl_Productos_20121210_Prueba
    {
        ...
        public int Components_on_Sales_Orders { get; set; }
        public int Components_on_Shipments { get; set; }
        public int Components_on_Invoices { get; set; }
        public int Components_on_Pick_Tickets { get; set; }
        public int Roll_up_Kit_Pricing { get; set; }
        public byte Automatic_Build_Kit_BOM { get; set; }
        public string Categoria_de_series { get; set; }
        public string Cod__almacen { get; set; }
        public string Cod__compra { get; set; }
        ...
        public decimal PreVtaDlls { get; set; }
        public byte CapturaNAV { get; set; }
